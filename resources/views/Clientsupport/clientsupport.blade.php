@extends('layouts.clientsupport.master-dashboard')
@section('title')
        ...
        <section>
            ...
            <div class="card card-cascade narrower z-depth-1">
                ...
                <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" class="white-text mx-3">Client Support</a>
                    <div>
                ...
                <div class="px-4">
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover mb-0" id="categories">
                            ...
                            <!--Table body-->
                            <tbody>
                            @foreach($csrequest as $item)
                                @if($item->REQ_STATUS == '6')
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-outline-info" href="#"
                                               onclick="accept('{{$item->id}}','{{\Carbon\Carbon::parse($item->REQ_DATE)->format('d-m-Y')}}','{{$item->REQSTATUS_NAME}}','{{$item->CUST_NAME}}',
                                                       '{{$item->MNAME}}','{{$item->FORM_REPORT}}','{{$item->RMKS}}','{{$item->ASSGN_TO_EMP}}','{{$item->CHK_BY_EMP}}',
        ...
        <div class="modal-dialog modal-fluid cascading-modal mt-4" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header light-blue darken-3 white-text">
                    <h4 class="mt-2" style="margin-left: 45%"><i class="fa fa-newspaper-o"></i> For Implementation
                    </h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row ml-1">
                                    <div class="md-form form-sm mr-5">
                                        ...
                                        <label for="asgnto">Assign TO</label>
                                    </div>
                                    <div class="md-form form-sm mr-5">
                                        <i class="fa fa-edit prefix "></i>
                                        <input placeholder="Selected date" type="text"
    ...
    <!--end section-->
        ...
        @section('javaScript')
            <script>
                ...
                function accept(id, req_date, req_status, Fkcust, mname, form_report, rmks, assgn_to, check_by, assgn_date, start_date, end_date, days) {
