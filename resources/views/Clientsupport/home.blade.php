                ...
                <div class="card-body">
                    ...
                    <table class="table no-header mt-1">
                        ...
                        <tr>
                            ...
                            <td class="hour">
                                <small><span class="grey-text float-right"><i class="fa fa-clock-o"
                                                                              aria-hidden="true"></i> 12 min</span>
                                </small>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <button class="btn btn btn-flat grey lighten-3 btn-rounded waves-effect font-weight-bold dark-grey-text float-right">
                        View full report
                    </button>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>John Doe</td>
                                <td class="hour">
                                    <small><span class="grey-text"><i class="fa fa-clock-o" aria-hidden="true"></i> 12 min</span>
                                    </small>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <h6 class="ml-4 pt-4 mt-1 dark-grey-text font-weight-bold"><i
                                        class="fa fa-long-arrow-up blue-text mr-3" aria-hidden="true"></i> 2000</h6>
                            <!--/.Card Data-->
