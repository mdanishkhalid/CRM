        ...
        <section>
            ...
            <div class="card card-cascade narrower z-depth-1">
                ...
                <div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" class="white-text mx-3">Request Status</a>
                    <div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover mb-0" id="categories">
                            ...
                            <tr>
                                ...
                                <th class="th-lg"><a href="#">Request Name</a></th>
                            ...
                            @foreach($cats as $cat)
                                <tr>
                                    <td>{{$cat->id}}</td>
                                    <td>{{$cat->REQSTATUS_NAME}}</td>
                                    <td>
                                        <a href="/reqsts/delete/{{$cat->id}}"><i
                                                    class="fa fa-close mr-1 blue-text"></i></a>
                                        <a href="#" onclick="edit('{{$cat->id}}','{{$cat->REQSTATUS_NAME}}')"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mb-0">
                    <div class="md-form form-sm">
                        ...
                        <label for="newname">Request name</label>
                    </div>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog cascading-modal" role="document">
            ...
            <div class="modal-content">
                ...
                <!--Header-->
                <div class="modal-header light-blue darken-3 white-text">
                    <h4 class=""><i class="fa fa-newspaper-o"></i> Edit Request Status</h4>
                    <button type="button" class="close waves-effect waves-light" data-dismiss="modal"
                            aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                ...
                <div class="modal-body mb-0">
                    ...
                    <div class="md-form form-sm">
                        <i class="fa fa-edit prefix"></i>
                        <input type="text" id="editname" class="form-control active" placeholder="Request Name">
                        {{--<label for="editname" class="active">Request name</label>--}}
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#save').click(function (event) {
                ...
                $.post('reqstatus', {'text': text, '_token': $('input[name=_token]').val()}, function (data) {
                    console.log(data);
